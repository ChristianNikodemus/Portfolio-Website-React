          ...
          <Row lg={3} md={2} sm={1} xs={1} className="g-4">
              ...
              <Card>
                ...
                <Card.Body>
                  <Card.Text>
                    ...
                    loads data from an external API and enables the viewing of
            ...
            <Col>
              <Card>
                ...
                <Card.Body>
                  <Card.Text>
                    A server-side component of a “movies” web application. The
                    web application provides users with access to information
                    about different movies, directors, and genres. Users are
                    able to sign up, update their personal information, and
              ...
              <Card>
                ...
                <Card.Body>
                  <Card.Text>
                    ...
                    called myFilms based on its existing server-side code (REST
                    API and database).
                  </Card.Text>
                  <Button
                    variant="outline-primary"
            ...
            <Col>
              <Card>
                ...
                <Card.Body>
                  <Card.Text>
                    A serverless, progressive web application (PWA) with React
                  ...
                  <ListGroup>
                    ...
                    <ListGroup.Item>React axios and async/await</ListGroup.Item>
                    <ListGroup.Item>
              ...
              <Card>
                ...
                <Card.Body>
                  ...
                  <ListGroup>
                    ...
                    <ListGroup.Item>Google Firestore Database</ListGroup.Item>
            ...
            <Col>
              <Card>
                ...
                <Card.Body>
                  <Card.Text>
                    Using Angular, I built the client-side for an application
                    called myFilms based on its existing server-side code (REST
                    API and database), with supporting documentation.
                  </Card.Text>
                  <Button
                    variant="outline-primary"
